...
class CheckRoute
{
    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        try{
            $permission = $permission = GrupoMenu::join('menus', 'menus.id_menu', 'grupos_menus.id_menu')
            ...
            ->orderBy('numero_ordenacao')
            ->groupBy('menus.id_menu', 'menus.icone', 'menus.chave', 'menus.valor', 'menus.submenu', 'menus.submenugroup', 'menus.numero_ordenacao')
            ->get()
            ->toArray();
            // echo "<pre>",print_r(['arr' => $permission]),exit;
